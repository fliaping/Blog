...
![docker-aufs-layer](https://storage.blog.fliaping.com/2017/10/docker-aufs-layer.png)
![aufs-merge](https://storage.blog.fliaping.com/2017/10/aufs-merge.png)
...
![aufs-layer](https://storage.blog.fliaping.com/2017/10/aufs-layer.png)
### btrfs
...
![btrfs](https://storage.blog.fliaping.com/2017/10/btrfs.png)
...
![device-mapper](https://storage.blog.fliaping.com/2017/10/device-mapper.png)
### overlay
...
![overlay](https://storage.blog.fliaping.com/2017/10/overlay.png)
...
![zfs-pool](https://storage.blog.fliaping.com/2017/10/zfs-pool.png)
下面看一下在Docker里ZFS的使用。首先从zpool里分配一个ZFS文件系统给镜像的基础层，而其他镜像层则是这个ZFS文件系统快照的克隆，快照是只读的，而克隆是可写的，当容器启动时则在镜像的最顶层生成一个可写层。如下图所示：
![zsh-container](https://storage.blog.fliaping.com/2017/10/zsh-container.png)
